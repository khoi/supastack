...
- file reads against any `SKILL.md` file (workspace `.agents/skills/`, user-level `${CODEX_HOME:-$HOME/.codex}/skills/`, or plugin-installed paths under `${CODEX_HOME:-$HOME/.codex}/plugins/cache/`)
- native Codex subagent prompts that name a skill path
