...
The workflow map in `${CODEX_HOME:-$HOME/.codex}/supastack/models.toml` controls the default panel when the current Codex interface supports model and reasoning-effort overrides.
